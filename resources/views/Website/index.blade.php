                                    ...
                                    <div class="block-daily-deals-content">
                                        <div class="owl-carousel nav-style2 equal-container" data-nav="true"
                                            ...
                                            <div class="deal-of-day equal-elem">
                                                <div class="product-thumb style1">
                                                    <div class="thumb-inner">
                                                        <a href="#"><img src="{{ asset('images/home3/d1.jpg') }}"
                                                                alt="d1"></a>
                                                    </div>
                                                </div>
                                                <div class="product-innfo">
                                                    <div class="info-text">
                                                        <div class="product-name"><a href="#">Notebook
                                                            </a></div>
                                                        <span class="price">
                                            ...
                                            @foreach ($sales_items as $sales_item)
                                                @if (isset($sales_item->discount->first()->amounts))
                                                    <div class="deal-of-day equal-elem">
                                                        <div class="product-thumb style1">
                                                            <div class="thumb-inner">
                                                                <a href="#"><img
                                                                        src="{{ asset($sales_item->coverImage->first()->image) }}"
                                                                        alt="d2"></a>
                                                            </div>
                                                        </div>
                                                        <div class="product-innfo">
                                                            <div class="info-text">
                                                                ...
                                                                <span class="price">
                                                                    ...
                                                                    <ins>{{ number_format($sales_item->price - $sales_item->discount->first()->amounts) }}</ins>
