                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{ route('products.store') }}">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" onkeyup="ChangeToSlug();" id="slug" placeholder="Tên sản phẩm">
                                <span style="color:red;">@error('name'){{ $message }} @enderror</span>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Slug</label>
                                <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" id="convert_slug" placeholder="Slug sản phẩm">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="price" class="form-control" value="{{ old('price') }}" id="convert_slug" placeholder="Giá">
                                <span style="color:red;">@error('price'){{ $message }} @enderror</span>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Mô tả</label>
                                <textarea name="description" value="" id="ckeditor_category" class="form-control" rows="3" style="resize: none">{!! old('description') !!}</textarea>
                            </div>
                            <div class="mb-3">
