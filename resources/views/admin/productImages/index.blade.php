                    ...
                    <div class="col-12 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                    ...
                                    <table id="dataTable" class="table ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset( $productImage->image) }}" alt="" style="width: 150px">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-3 fs-6">
                                                        <a href="{{ route('productImages.edit', $productImage->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                                                        <form action="{{ route('productImages.destroy', [$productImage->id]) }}" method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                            <a href="#" onclick="deleteproductImages({{ $productImage->id }})" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteproductImages"> <i class="bi bi-trash-fill"></i></a>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                {{-- Test Modal Delete --}}
                                <!-- Modal -->
                                <div class="modal fade" id="deleteproductImages" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
