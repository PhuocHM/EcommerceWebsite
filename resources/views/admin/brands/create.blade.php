                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{ route('brands.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" onkeyup="ChangeToSlug();" id="slug" placeholder="Tên thương hiệu">
                                <span style="color:red;">@error('name'){{ $message }} @enderror</span>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Slug</label>
                                <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" id="convert_slug" placeholder="Slug thương hiệu">
