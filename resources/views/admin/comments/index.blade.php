            ...
            <div class="col-md-12">
                <form class="form-inline my-2 my-lg-0">
                    <button style="float:right" class="btn btn-outline-success my-2 my-sm-0" type="submit">Tìm
                        kiếm</button>
                    <input style="width: 300px; margin-right: 10px; float:right" class="form-control" action="{{ route('suppliers.index') }}" method="GET" name="comment" type="text" placeholder="Tìm kiếm">
                    </select>
                </form>
            </div>
        </div>
                                    ...
                                    <table id="dataTable" class="table ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" onclick="deleteComment({{ $comment->id }})" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteComment"> <i class="bi bi-trash-fill"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
