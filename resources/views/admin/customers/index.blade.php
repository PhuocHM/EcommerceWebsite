            ...
            <div class="col-md-12">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <button style="float:right" class="btn btn-outline-success my-2 my-sm-0" type="submit">Tìm
                        kiếm</button>
                    <input style="width: 300px; margin-right: 10px; float:right" class="form-control" action="{{ route('customers.index') }}" method="GET" name="customer" type="text" placeholder="Tìm kiếm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3 fs-6">
                                                        ...
                                                        <a href="{{ route('customers.edit', $customer->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit info" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                                                        <form action="{{ route('customers.destroy', [$customer->id]) }}" method="POST">
                                                            ...
                                                            data-bs-target="#deleteCustomer"> <i class="bi bi-trash-fill"></i></a> --}}
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
